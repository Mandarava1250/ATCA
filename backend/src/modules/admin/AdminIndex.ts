...
router.post('/architectures', validateBody(z.object({
  name: z.string().min(1),
  type: z.string().min(1),
  chinese_name: z.string().nullable().optional(),
  founding_dynasty: z.string().nullable().optional(),
  completed_dynasty: z.string().nullable().optional(),
  location: z.string().nullable().optional(),
  coordinates: z.string().nullable().optional(),
  latitude: z.coerce.number().nullable().optional(),
  longitude: z.coerce.number().nullable().optional(),
  construction_date: z.string().nullable().optional(),
  architect: z.string().nullable().optional(),
  protection_level: z.string().nullable().optional(),
  ...
  structural_features: z.string().nullable().optional(),
  ...
  image_gallery: z.union([z.string(), z.array(z.string())]).nullable().optional(),
  model_3d_url: z.string().nullable().optional(),
  vr_panorama_url: z.string().nullable().optional(),
})), asyncHandler(async (req: any, res) => {
...
router.put('/architectures/:id', asyncHandler(async (req: any, res) => {
  ...
  const schema = z.object({
    ...
    architect: z.string().nullable().optional(),
    protection_level: z.string().nullable().optional(),
    is_featured: z.coerce.boolean().nullable().optional(),
    brief_description: z.string().nullable().optional(),
    full_description: z.string().nullable().optional(),
    structural_features: z.string().nullable().optional(),
    historical_significance: z.string().nullable().optional(),
