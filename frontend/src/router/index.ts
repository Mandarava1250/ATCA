  ...
  routes: [
    ...
    // 管理员路由
    {
      ...
      children: [
        ...
        { path: 'knowledge-graph', name: 'AdminKnowledgeGraph', component: () => import('@/views/admin/AdminKnowledgeGraph.vue') },
        { path: 'community', name: 'AdminCommunity', component: () => import('@/views/admin/AdminCommunity.vue') },
        { path: 'translation', name: 'AdminTranslation', component: () => import('@/views/admin/AdminTranslation.vue') },
